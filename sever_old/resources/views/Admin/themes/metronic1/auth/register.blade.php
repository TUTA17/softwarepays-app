...
<div class="m-grid m-grid--hor m-grid--root m-page">
	<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--signin m-login--2 m-login-2--skin-1" id="m_login" style="background-image: url({{ asset('/auth_assets/images/bg-1.jpg') }}) !important;">
				...
				<div class="signup">
					...
					<form method="post" class="m-login__form m-form" action="">
						...
						<div class="row form-group m-form__group m-login__form-sub">
							<div class="col m--align-left">
								<label class="m-checkbox m-checkbox--light">
									<input type="checkbox" name="agree">{{""}} <a href="#" class="m-link m-link--focus">{{""}}.</a>.
									<span></span>
								</label>
						...
						<div class="m-login__form-action">
							<button type="submit" class="btn m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn m-login__btn--primary">{{""}}</button>&nbsp;&nbsp;
							<a href="/admin/login" class="btn m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn">{{""}}</a>
						</div>
					</form>
				</div>
...
<link rel="stylesheet" href="{{asset('auth_assets/js/login.js')}}">
