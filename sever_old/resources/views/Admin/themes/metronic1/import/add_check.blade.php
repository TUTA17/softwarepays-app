...
{{--                                            {{dd($field['type'])}}--}}
{{--                                            @include(config('core.admin_theme').".khoweb.top.".$field['field'], ['field' => $field])--}}
            ...
            <div class="col-xs-12 col-md-6">
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            <ul>
                                <li><a href="https://youtu.be/08qs4CtnuO0" target="_blank">Hướng dẫn import đầu mối</a>
                                </li>
                            </ul>
                        </div>
                    </div>
