    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet kt-portlet--mobile">
			...
			<span class="kt-portlet__head-icon">
                <i class="kt-font-brand flaticon-download-1"></i>
			</span>
                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
                                ...
                                @foreach($module['list'] as $field)
                                    <td data-field="{{ @$field['name'] }}"
                                        ...
                                        @if($field['type'] == 'custom')
                                            @include(config('core.admin_theme').'.'.$field['td'], ['field' => $field])
                                        @else
                    ...
                    <div class="kt-datatable__pager kt-datatable--paging-loaded">
                        ...
                        <div class="kt-datatable__pager-info">
                            ...
                            <span class="kt-datatable__pager-detail">{{""}} {{ (($page - 1) * $limit) + 1 }} - {{ ($page * $limit) < $record_total ? ($page * $limit) : $record_total }} của {{ @$record_total }}</span>
                        </div>
                    </div>
                </div>
                <!--end: Datatable -->
