    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet kt-portlet--mobile">
			...
			<span class="kt-portlet__head-icon">
                <i class="kt-font-brand flaticon2-sort-down"></i>
			</span>
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <button type="button" class="btn btn-info btn-icon-sm ">
                                <i class="flaticon-refresh"></i> {{""}}
                            </button>
                            <button type="button" class="btn btn-success btn-icon-sm ">
                            ...
                            {{--<a href="{{ url('/admin/'.$module['code'].'/add/') }}"--}}
                               {{--class="btn btn-brand btn-elevate btn-icon-sm" title="Tạo {{ @$module['label'] }} mới">--}}
                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
                    ...
                    <div class="kt-datatable__pager kt-datatable--paging-loaded">
                        ...
                        <div class="kt-datatable__pager-info">
                            ...
                            <span class="kt-datatable__pager-detail">{{""}} {{ (($page - 1) * $limit) + 1 }} - {{ ($page * $limit) < $record_total ? ($page * $limit) : $record_total }} {{""}} {{ @$record_total }}</span>
                        </div>
                    </div>
                </div>
                <!--end: Datatable -->
