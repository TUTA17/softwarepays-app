                        ...
                        <table style="width:100%;border-collapse:collapse">
                            ...
                            <tr>
                                <td style="width:140px">
                                    <img src="{{asset($settings['logo'])}}" class="{{$settings['name']}}">

                                </td>
                                <td style="padding-left:10px;font:16px/1.6 Arial;color:#000;font-weight:bold;text-align:right">{{""}} {{@$settings['name']}}</td>
                            </tr>
                            </tbody>
                        </table>
                    </td>
