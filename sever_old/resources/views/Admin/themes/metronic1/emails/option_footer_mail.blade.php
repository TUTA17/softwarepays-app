                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body" style="padding-top: 0;">
                            <div class="kt-section kt-section--first">
                                <div class="flexbox-annotated-section-annotation">
                                    <textarea id="footer_mail"
                                              name="footer_mail">{{ @\App\Models\Setting::where('name', 'footer_mail')->where('type', 'mail')->first()->value }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('custom_footer')
    ...
    <script>
        CodeMirror.fromTextArea(document.getElementById("footer_mail"), {
            lineNumbers: true,
            mode: "text/html",
            matchBrackets: true
        });
