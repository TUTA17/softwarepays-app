                        ...
                        <div class="kt-widget kt-widget--user-profile-1">
                            <div class="kt-widget__head">
                                <div class="kt-widget__media">
                                    <img style=""
                                         src="{{ asset(@$result->image, null, null) }}"
                            ...
                            <div class="kt-widget__body">
                                <div class="kt-widget__content">
                                    ...
                                    <div class="kt-widget__info">
                                        <span class="kt-widget__label">{{""}}:</span>
                                        <a href="#" class="kt-widget__data">{{$result->cccd}}</a>
                                    </div>
                                    <div class="kt-widget__info">
                                        <span class="kt-widget__label">{{""}}:</span>
                                        <a href="#" class="kt-widget__data">{{$result->gioitinh}}</a>
                                    </div>
                                    <div class="kt-widget__info">
                                    </div>
                                    <div class="kt-widget__head">
                                        <div class="kt-widget__media">
                                            <img style=""
                                                 src="{{ asset(@$result->ID_card_photo_on_the_front, null, null) }}"
                                                 class="user-image user-lg-img"
                                                 alt="{{ @$result->ID_card_photo_on_the_front }}"
                                                 title="{{ @$result->ID_card_photo_on_the_front }}">
                                        </div>
                                        <div class="kt-widget__content">
                                            <div class="kt-widget__section">
                                                <a href="#" class="kt-widget__username">
                                    ...
                                    <div class="kt-widget__head">
                                        <div class="kt-widget__media">
                                            <img style=""
                                                 src="{{ asset(@$result->ID_card_photo_on_the_back, null, null) }}"
                                                 class="user-image user-lg-img"
                                                 alt="{{ @$result->ID_card_photo_on_the_back }}"
                                                 title="{{ @$result->ID_card_photo_on_the_back }}">
                                        </div>
                                        <div class="kt-widget__content">
                                            <div class="kt-widget__section">
                                                <a href="#" class="kt-widget__username">
                                ...
                                <div class="kt-widget__items">
                                    ...
                                    <a href="{{route('logoutAllDevise')}}">Đăng xuất khỏi các thiết bị khác</a>
