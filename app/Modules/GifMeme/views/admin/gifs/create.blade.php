...
@section('content')
    <div class="page-header">
        <div><h1 class="page-title">Tải Gif Lên</h1></div>
    </div>
    ...
    <div class="card" style="padding:24px;">
        <form action="{{ route('admin.gifmeme.gifs.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div style="display:grid; grid-template-columns: 2fr 1fr; gap:24px;">
                <div>
                    ...
                    <div class="form-group" style="margin-bottom:16px;">
                        <label style="display:block; margin-bottom:8px;">File âm thanh (mp3, ogg, wav, webm, m4a — tối đa {{ config('gif.max_upload_mb') }}MB)</label>
