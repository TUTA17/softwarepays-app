...
@section('content')
    ...
    <div class="card" style="margin-bottom: 24px; padding: 20px;">
        ...
        <form action="{{ route('admin.gifmeme.categories.store') }}" method="POST" style="display: flex; gap: 10px; flex-wrap: wrap; align-items: flex-end;">
            @csrf
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('admin.gifmeme.categories.destroy', $cat->id) }}" method="POST" onsubmit="return confirm('Xoá danh mục này?');" style="display:inline;">
                                @csrf
                                @method('DELETE')
